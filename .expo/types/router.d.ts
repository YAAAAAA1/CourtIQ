...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/ai-coach` | `/ai-coach` | `/(app)/analytics` | `/analytics` | `/(app)/calender` | `/calender` | `/(app)/drill-practice` | `/drill-practice` | `/(app)/drills-library` | `/drills-library` | `/(app)/goals` | `/goals` | `/(app)/` | `/(app)` | `/(app)/nutrition` | `/nutrition` | `/(app)/program-creator` | `/program-creator` | `/(app)/program-schedule` | `/program-schedule` | `/(app)/settings` | `/settings` | `/(app)/workout-execution` | `/workout-execution` | `/(app)/workouts-new` | `/workouts-new` | `/(app)/workouts` | `/workouts` | `/(auth)/` | `/(auth)` | `/(auth)/signin` | `/signin` | `/(auth)/signup` | `/signup` | `/(tabs)/` | `/(tabs)` | `/modal` | `/onboarding/` | `/onboarding/profile`;
  // prettier-ignore
